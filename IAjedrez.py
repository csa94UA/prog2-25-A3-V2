...
class IADeAjedrez:
    def __init__(self, enemigo:"Jugador",jugador:"Jugador",max_profundidad:int=5)->None:
        """
    ...
    def alfa_beta(self, tablero:Tablero, profundidad:int, alfa:float, beta:float, maximizando:bool)->float:  
        ...
        """
        tablero_fen = tablero.traduccion_FEN(tablero.turno, tablero.enroque[0] if tablero.enroque else False, tablero.enroque[1] if tablero.enroque else False , tablero.en_passant, tablero.contador, tablero.turno)
